...
public:
	...
	virtual void rmbegin(const Point source, const Point target) {}
	virtual void rmmove(const Point source, const Point target) {};
	virtual void rmend(const Point source, const Point target) {};
	...
	//checkBoundary
	bool CheckBoundary(Point target);
